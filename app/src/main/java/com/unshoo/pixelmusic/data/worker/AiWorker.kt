...
import com.unshoo.pixelmusic.data.ai.AiNotificationManager
import com.unshoo.pixelmusic.data.ai.AiOrchestrator
import com.unshoo.pixelmusic.data.ai.AiSystemPromptType
import com.unshoo.pixelmusic.data.ai.UserProfileDigestGenerator
...
class AiWorker @AssistedInject constructor(
    ...
    private val preferencesRepo: com.unshoo.pixelmusic.data.preferences.AiPreferencesRepository
