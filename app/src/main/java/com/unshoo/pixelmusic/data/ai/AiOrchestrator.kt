package com.unshoo.pixelmusic.data.ai
...
import com.unshoo.pixelmusic.data.database.AiCacheEntity
...
class AiOrchestrator @Inject constructor(
    ...
    private suspend fun generateWithRecovery(
        ...
        return try {
            ...
            throw com.unshoo.pixelmusic.data.ai.provider.AiProviderSupport.createException(
            ...
            val failure = com.unshoo.pixelmusic.data.ai.provider.AiProviderSupport.wrapThrowable(
    ...
    private suspend fun recoverModelIfNeeded(
        ...
        client: com.unshoo.pixelmusic.data.ai.provider.AiClient,
        failure: com.unshoo.pixelmusic.data.ai.provider.AiProviderException
    ): String? {
        ...
        val recoveredModel = com.unshoo.pixelmusic.data.ai.provider.AiProviderSupport.selectRecoveryModel(
    ...
    suspend fun generateContent(
        ...
        val providersToTry = com.unshoo.pixelmusic.data.ai.provider.AiProviderSupport.buildProviderChain(userProvider)
        ...
        for (provider in providersToTry) {
            ...
            try {
                ...
                val failure = com.unshoo.pixelmusic.data.ai.provider.AiProviderSupport.wrapThrowable(provider.displayName, e)
