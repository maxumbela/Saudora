...
import com.unshoo.pixelmusic.data.database.SongEntity // Necesario para datos de prueba
import com.unshoo.pixelmusic.data.database.AlbumEntity
import com.unshoo.pixelmusic.data.database.ArtistEntity
import com.unshoo.pixelmusic.data.model.Song // Para verificar el mapeo
...
class MusicRepositoryImplTest {
    ...
    private val mockTelegramCacheManager: com.unshoo.pixelmusic.data.telegram.TelegramCacheManager = mockk(relaxed = true)
    private val mockTelegramRepository: com.unshoo.pixelmusic.data.telegram.TelegramRepository = mockk(relaxed = true)
    private val mockTelegramCacheManagerProvider: Lazy<com.unshoo.pixelmusic.data.telegram.TelegramCacheManager> = mockk()
    private val mockTelegramRepositoryProvider: Lazy<com.unshoo.pixelmusic.data.telegram.TelegramRepository> = mockk()
